...
double_byte = ['é', 'ö', 'Á', 'à', 'ü', 'ç', 'ã', 'ô', 'Ü', 'ō', 'ñ', 'ý', 'á', 'ĕ', 'Ç', 'è', 'É', 'â', 'ú', 'ó', 'í', 'ê', '☮', '_☮︎︎_', 'ï', 'Ö', 'ä', 'À', 'ž', 'û']
single_byte = ['é', 'ö', 'Á', 'à', 'ü', 'ç', 'ã', 'ô', 'Ü', 'ō', 'ñ', 'ý', 'á', 'ĕ', 'Ç', 'è', 'É', 'â', 'ú', 'ó', 'í', 'ê', '☮︎', '_☮︎_', 'ï', 'Ö', 'ä', 'À', 'ž', 'û']
